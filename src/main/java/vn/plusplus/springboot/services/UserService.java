...
public class UserService implements UserDetailsService {
    ...
    @Autowired
    AccountJPArepo userRepository;

    @Override
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        AccountJpa userEntity = userRepository.findByPhoneJpa(userName);
        if (userEntity == null) {
        ...
        UserDetails userDetails = (UserDetails) new User(userEntity.getPhoneJpa(), //
